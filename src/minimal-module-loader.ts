...
const loader = window.createModuleLoader(
	`https://cdn.jsdelivr.net/gh/Woyken/project-cactus-byte@${packageJson.version}/`,
);
loader.loadScript(
	`https://cdn.jsdelivr.net/gh/Woyken/project-cactus-byte@${packageJson.version}/entryPoint.js`,
);
