...
This project supports building with CDN prefix URLs for deployment to CDNs like jsDelivr, GitHub Pages, or custom CDNs:

```bash
# Build with CDN prefix
node build-with-cdn.js https://cdn.jsdelivr.net/gh/username/repo/dist/

# Or using environment variable
CDN_PREFIX_URL=https://cdn.jsdelivr.net/gh/username/repo/dist/ pnpm build
```

See [CDN_DEPLOYMENT.md](./CDN_DEPLOYMENT.md) for detailed instructions.
